...
// 8x8 bitmap font - ASCII 0-127 + CP437 extended (0x80-0xFF)
// Each character is 8 bytes, each byte is one row (MSB = left pixel)
const uint8_t font_data[FONT_CHARS][8] = {
    ...
    ['&']  = {0x38, 0x6C, 0x38, 0x76, 0x6C, 0x6C, 0x36, 0x00},
    ...
    [0xC8] = {0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0xFC, 0xFC},  // ╚
    [0xC9] = {0xFC, 0xFC, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0},  // ╔
    [0xBA] = {0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3},  // ║
    [0xBB] = {0x3F, 0x3F, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03},  // ╗
    [0xBC] = {0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x3F, 0x3F},  // ╝
    [0xCD] = {0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00},  // ═

    // CP437 single-line box
    [0xB3] = {0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18},  // │
    [0xC4] = {0x00, 0x00, 0x7E, 0x00, 0x00, 0x7E, 0x00, 0x00},  // ─
};